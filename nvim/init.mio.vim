...
" Not necessary, since we are using coc.vim for python-lsp: Plug 'neovim/nvim-lspconfig'
call plug#end()
...
autocmd FileType python setlocal expandtab shiftwidth=3 softtabstop=3 tabstop=3

" Disable syntastic for python lsp. we are using coc.vim
